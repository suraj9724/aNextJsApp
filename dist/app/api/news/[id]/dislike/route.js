...
const rss_validation_js_1 = require("../../../../../validations/rss.validation"); // For param validation
...
async function POST(req, { params }) {
    ...
    try {
        ...
        const updatedNews = await news_model_js_1.default.findById(params.id).select('likes dislikes likedBy dislikedBy');
        ...
        return server_1.NextResponse.json({ message: 'Error disliking news item', error: err.message }, { status: 500 });
    }
}
